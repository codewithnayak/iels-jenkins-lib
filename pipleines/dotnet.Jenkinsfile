    ...
    stage('Build And Push Image'){
      steps{
          script{
            container('kaniko'){
              sh '''
              /kaniko/executor  --dockerfile=Dockerfile --context .  --destination europe-west2-docker.pkg.dev/primeval-nectar-431120-j5/iels-artifact-repository/${IMG_NAME}:1.${BUILD_NUMBER}.0
              '''
